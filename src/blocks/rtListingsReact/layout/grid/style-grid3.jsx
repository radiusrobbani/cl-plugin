import {
	ListingItemContainer, ListingContainer, BadgeContainer, ButtonContainer,
	IconBtnContainer, PriceContainer2, SoldContainer, ItemContentContainer
									...
									{content_visibility["phone_btn"] && listing.phone ? (
										<ButtonContainer css={button_style} className="rtcl-phn rtcl-el-button">
											<a className="rtcl-gb-phone-reveal not-revealed" href="#" data-phone={listing.phone}>
												<i className="rtcl-icon-phone"></i><span>{__("Show Phone No", "classified-listing")}</span>
											</a>
										</ButtonContainer>
									) : ""}
