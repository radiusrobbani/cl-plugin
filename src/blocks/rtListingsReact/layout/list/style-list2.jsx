								...
								<div className="right-content">
									<UL css={meta_style} className="rtcl-listing-meta-data">
										{(content_visibility["listing_type"] && listing.listing_type) ? (
											<li className="rtcl-type"><i className="rtcl-icon rtcl-icon-tags"></i>{listing.listing_type}</li>
										) : ''}
									...
									{(content_visibility["details_btn"] && listing.post_link) ? (
										<ButtonContainer css={button_style} className="rtcl-details"><a href={listing.post_link}>Details</a></ButtonContainer>
									) : ''}
