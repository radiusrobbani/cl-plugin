...
import { BadgeContainer, ListingItemContainer, ButtonContainer, PriceContainer, SoldContainer, ItemContentContainer } from '../../components/styles/Container.styles';
							...
							<ListingItemContainer css={col_style} css_pad={col_padding} css_pm={promotion_style} className={listing.classes ? Object.values(listing.classes).join(" ") : ''}>
								...
								<div className="right-content">
									...
									{(content_visibility["listing_type"] && listing.listing_type) ? (
										<div className="rtcl-listing-type"><i className="rtcl-icon rtcl-icon-tags"></i>{listing.listing_type}</div>
									) : ''}
									...
									{content_visibility["phone_btn"] && listing.phone ? (
										<ButtonContainer css={button_style} className="rtcl-phn rtcl-el-button">
											<a className="rtcl-gb-phone-reveal not-revealed" href="#" data-phone={listing.phone}>
												<i className="rtcl-icon rtcl-icon-phone"></i>
