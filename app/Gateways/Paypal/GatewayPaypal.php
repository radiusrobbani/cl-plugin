...
class GatewayPaypal extends PaymentGateway
{
	...
	public function is_valid_for_use() {
		return in_array(Functions::get_currency(true),
			apply_filters(
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'image_url'             => array(
				...
				'type'        => 'text',
				'description' => esc_html__('Optionally enter the URL to a 150x50px image displayed as your logo in the upper left corner of the PayPal checkout pages.', 'classified-listing'),
				'default'     => '',
				'placeholder' => esc_html__('Optional', 'classified-listing'),
			),
			'api_details'           => array(
