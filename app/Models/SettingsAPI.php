...
abstract class SettingsAPI
{
    ...
    public function get_form_fields() {
        ...
        return apply_filters('rtcl_settings_api_form_fields_' . $this->option,
    ...
    public function admin_options() {
        echo '<table class="form-table">' . $this->generate_settings_html($this->get_form_fields(),
                false) . '</table>';
    }
            ...
            <td class="form-input">
                <div class="rtcl-geo-address-field" style="max-width: 400px">
                    <input id="<?php echo esc_attr($id); ?>" type="text"
                           ...
                           placeholder="Select a location" class="form-control rtcl-geo-address-input rtcl_geo_address_input"
                           aria-invalid="false">
    ...
    public function generate_html_html($key, $data) {
        ...
        <tr valign="top" class="<?php echo esc_attr($wrapper_class); ?>" <?php echo $depends; ?>>
            ...
            <td class="form-input">
                <?php echo isset($data['html']) ? wp_kses_post($data['html']) : ''; ?>
                <?php echo $this->get_description_html($data); ?>
            </td>
        </tr>
        <?php
                ...
                <fieldset>
                    ...
                    <select class="select <?php echo esc_attr($data['class']); ?>"
                        ...
                        <?php if (!empty($data['blank'])): ?>
                            <option value="<?php echo esc_attr($data['blank_value']); ?>"><?php echo esc_attr($data['blank_text']); ?></option>
                        <?php endif; ?>
                        <?php foreach ((array)$data['options'] as $option_key => $option_value) : ?>
                    ...
                    <select multiple="multiple" class="multiselect <?php echo esc_attr($data['class']); ?>"
                        ...
                        <?php foreach ((array)$data['options'] as $option_key => $option_value) : ?>
                            <option value="<?php echo esc_attr($option_key); ?>" <?php selected(in_array($option_key,
                                $value), true); ?>><?php echo esc_attr($option_value); ?></option>
                        <?php endforeach; ?>
                    </select>
                    <?php echo $this->get_description_html($data); ?>
