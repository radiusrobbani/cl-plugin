...
class Options
{
	...
	public static function get_admin_email_notification_options() {
		$options = array(
			...
			'listing_contact'   => esc_html__('A contact message is sent to a listing owner', 'classified-listing')
		);
	...
	public static function get_email_type_options() {
		$types = array('plain' => esc_html__('Plain text', 'classified-listing'));
	...
	public static function addons() {
		$addons = [
			...
			'classified_listing_multilingual' => [
			...
			'classified_listing_razorpay'        => [
				'title'    => 'Classified Listing - Razorpay Gateway',
				'img_url'  => 'https://radiustheme.com/our-plugins/Razorpay-payment-addon-for-classified-listing.png',
				'demo_url' => 'https://radiustheme.com/demo/wordpress/classifiedpro/',
				'buy_url'  => 'https://www.radiustheme.com/downloads/razorpay-payment-addon-for-classified-listing/',
			],
			'theme_classima'                  => [
			...
			'classified_listing_app'          => [
				'title'    => 'Classified Listing Android App',
