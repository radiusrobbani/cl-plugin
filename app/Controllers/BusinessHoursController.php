...
class BusinessHoursController
{
	...
	public static function openStatus($business_hours) {
		$current_dayKey = 2;//absint(date('w', current_time('timestamp')));
	...
	public static function display_business_hours() {
		global $listing;
		...
		$defaults = [
			...
			'close_today_text'      => esc_html__('Closed Today', 'classified-listing'),
