...
$options = array(
    ...
    'email_template_section'      => array(
        ...
        'description' => sprintf('<strong>%s</strong>', esc_html__("You can use the following placeholders", "classified-listing")) . '<br>' .
            ...
            sprintf(esc_html__('This section lets you customize the Classified Listing emails. <a href="%s" target="_blank">Click here to preview your email template.</a>', "classified-listing"), wp_nonce_url(admin_url('?preview_rtcl_mail=true'), 'preview-mail'))
    ),
